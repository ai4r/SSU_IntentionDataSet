...
```description03
   ...
   and 4 types of IoT sensor information. Therefore, this data was represented by sequences to compose of action, pose, 
   IoT sensor information and activity intention. 
```
